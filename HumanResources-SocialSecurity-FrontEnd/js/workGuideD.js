            ...
            if (result.serviceAttachModels) {
                ...
                for (var i = 0; i < result.serviceAttachModels.length; i++) {
                    ...
                    html += '<div class="first">' +
                        ...
                        '</div>' +
                        '<div class="fr">' +
                        '<a href="http://192.168.100.84:8520/egov-socialsecurity' + result.serviceAttachModels[i].attachFrom + '"  download="' + result.serviceAttachModels[i].attachName + '"> <img src="./img/load.png" alt=""></a>' +
                        '</div>' +
                        '</div>'
